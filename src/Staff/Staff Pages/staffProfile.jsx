  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center py-10 px-4">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        {/* Header */}
        <div className="bg-amber-50 p-8 flex items-center gap-6">
          <div className="w-24 h-24 bg-amber-200 rounded-full flex items-center justify-center text-4xl text-amber-700 shadow-md">
            <FaUserAlt />
          </div>
          <div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <label className="w-32 font-semibold text-gray-700">Full Name:</label>
            <input
              type="text"
              defaultValue={staff.name}
              onChange={(e) => handleChange("name", e.target.value)}
              className="flex-1 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-500 bg-gray-50"
            />
            <button
              onClick={() => handleUpdate("name")}
              className="bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 shadow-md transition"
            >
              Update
            </button>
          </div>
          ...
          {/* Password */}
          <div className="flex flex-col md:flex-row items-center gap-4">
            <label className="w-32 font-semibold text-gray-700">Password:</label>
            <input
              type="password"
          ...
          {/* Role */}
          <div className="flex flex-col md:flex-row items-center gap-4">
            <label className="w-32 font-semibold text-gray-700">Role:</label>
            <select
