    ...
    <div className="flex min-h-screen bg-amber-50">
      ...
      <div className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between bg-white border-b border-gray-200 px-4 py-3 md:hidden">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-800">Imman Café</p>
            <p className="text-xs text-gray-500">Admin Portal</p>
          </div>
        </div>
        <button
          onClick={() => setIsSidebarOpen((prev) => !prev)}
          className="p-2 rounded-lg border border-amber-200 text-amber-700"
        >
      ...
      <aside
        className={`
          fixed md:static inset-y-0 left-0 z-40 w-72 bg-white shadow-xl flex flex-col transform transition-transform duration-200
          ${isSidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}
        `}
      >
        {/* Header */}
        <div className="hidden md:flex p-6 items-center gap-3 border-b border-gray-200">
        ...
        <div className="p-4 flex-1 flex flex-col">
          <div className="bg-amber-100 p-4 rounded-xl flex items-center gap-3 mb-6 mt-12 md:mt-0">
          ...
          <div className="mt-auto pt-6 border-t border-gray-200">
            <button
              ...
              className="flex items-center gap-3 text-red-600 font-medium text-sm hover:bg-red-50 px-3 py-2 rounded-lg transition-all w-full"
            >
